...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Iroquois Dental" },
      ...
      { name: "twitter:title", content: "Iroquois Dental — Healthy Smiles Begin Here" },
      { name: "twitter:description", content: "Family, cosmetic and emergency dentistry in Iroquois, Ontario. Book your appointment with our friendly, modern dental team today." },
    ],
    links: [
      {
        rel: "stylesheet",
